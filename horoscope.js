...
function selffunction() {
    ...
    var textrowa, result, hs;

    textrowa = "Here is your Horoscope: ";
    document.getElementById("textrow1").innerHTML = textrowa;
    hs = document.getElementById("horoscope").value;

    // Array containing horoscope details for each zodiac sign
    var horo = [
    ...
    // Array containing image sources for each zodiac sign
    var src = [
    ...
    // Clear the previously appended image
    document.getElementById('img_horo').innerHTML = '';

    // Determine horoscope result and image based on selected zodiac
    switch (hs) {
        case "Aries":
            result = horo[0];
            appendImage(src[0]);
        ...
        case "Pisces":
            ...
            break;
        default:
            result = "Please select a valid zodiac sign.";
    }
